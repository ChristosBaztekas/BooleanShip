...
public class Schools extends Organisations implements caseManagmentAndHumanAddition {
    ...
    private ArrayList<covid.app.main.app.boolship.Human> teachers = new ArrayList<covid.app.main.app.boolship.Human>();
    private ArrayList<Classes> departments = new ArrayList<Classes>();
    private ArrayList<covid.app.main.app.boolship.Human> others = new ArrayList<covid.app.main.app.boolship.Human>();
    ...
    public Schools(String name, String area, int numbersOfPeople,String mail) {
    ...
    public static void createOrg() {
        ...
        Schools newOn = new Schools(name,area,teachers+students,"mail");
    }
    ...
    protected void findPerson(covid.app.main.app.boolship.Human human) {
        ...
        for (int i = 0; i < departments.size(); i++) {
            covid.app.main.app.boolship.Human one = departments.get(i).isSame(look);
            if (one != null) {
